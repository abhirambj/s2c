...
export const useProjectCreation = () => {
	...
	const generateGradientThumbnail = () => {
		...
		const svgContent = `
            <svg width="300" height="200" xmlns="http://www.w3.org/2000/svg">
                ...
                <circle cx="150" cy="100" r="30" fill="white" opacoty="0.8" />
                <path d="M140 90 L160 110 L140 110 Z" fill="white" opacity="0.6" />
            </svg>
        `;
	...
	const createProject = async (name?: string) => {
		...
		try {
			...
			dispatch(createProjectFailue("Failed to create project"));
